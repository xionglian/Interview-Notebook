...
[Http缓存中的ETag和Cache-Control](https://developers.google.com/web/fundamentals/performance/optimizing-content-efficiency/http-caching?hl=zh-cn)

## ISP

网络服务提供商（ISP）是网络访问的第一跳，通过将数据缓存在 ISP 中能够大大提高用户的访问速度。可能存在串号问题。

[ISP缓存](https://blog.csdn.net/xingzhaozhong/article/details/50755984)
## 反向代理

反向代理位于服务器之前，请求与响应都需要经过反向代理。通过将数据缓存在反向代理，在用户请求反向代理时就可以直接使用缓存进行响应。

[nginx反向代理-动静分离](http://blog.51cto.com/yw666/1907624)
## 本地缓存

使用 Guava Cache 将数据缓存在服务器本地内存中，服务器代码可以直接读取本地内存中的缓存，速度非常快。

[Guava Cache使用demo](https://www.cnblogs.com/parryyang/p/5777019.html)
## 分布式缓存
